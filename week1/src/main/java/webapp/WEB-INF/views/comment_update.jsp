...
<script>
	...
	function goCommentUpdate(){
		board.t_gubun.value="commentUpdate";
		board.method="post";
		board.action="freeboard";
		board.submit();
	}
	...
	<div class="container">
		...
		<div class="write_wrap">
				...
				<table class="board_table">
					...
					<tbody>
						<tr>
							<th>댓글작성</th>
							<td class="th_left">
								<textarea name="t_comment" class="textArea_H250">${dto2.getContent()}</textarea>
							</td>
							<td class="buttontop"><input type="button" onClick="goCommentUpdate()" value="댓글수정" class="cbutton"></td>
						</tr>
					</tbody>
				</table>
			</div>
			...
			<div class="btn_wrap">
				...
				<c:if test="${dto2.getReg_id() eq sessionName and dtos.size() > 0}">
